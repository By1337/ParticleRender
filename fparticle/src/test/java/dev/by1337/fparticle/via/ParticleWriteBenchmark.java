...
import dev.by1337.fparticle.ParticleEffects;
...
public class ParticleWriteBenchmark {
    ...
    @Setup
    public void setup() {
        System.setProperty("fparticle.protocol", "754");

        computed = ParticleEffects.circle(1024*10, 10, ParticleData.of(ParticleType.CLOUD)).compute();

        encoder = new ParticleEncoder(null, null);
        encoder.setOut(new ByteBuf() {
